...
def play():
    ...
    icon_pedra = Image.open("F:\Pastas\Downloads\pedra.png")
    ...
    icon_papel = Image.open("F:\Pastas\Downloads\paper.png")
    ...
    icon_tesoura = Image.open("F:\Pastas\Downloads\scissor.png")
